    ...
    button.addEventListener('click', async () => {
      ...
      try {
        ...
        const openWhatsApp = async () => {
          ...
          buildModal('Ready message copied', 'Open WhatsApp, then paste the message with Ctrl+V. This bypasses WhatsApp Web\'s emoji-corrupting URL importer.', [
            { label: 'Open WhatsApp', primary: true, onClick: () => window.open(whatsappUrl.toString(), '_blank') },
          ]);
        };
