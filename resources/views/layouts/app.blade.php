...
<div class="shell">
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="nav">
            ...
            @if($u->hasPermission('accounting.view'))<a @class(['active'=>request()->routeIs('finance.account-transfer')]) href="{{ route('finance.account-transfer') }}">@include('partials._nav-icon',['name'=>'accounting']) Account Transfer</a>@endif
