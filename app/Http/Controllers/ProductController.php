...
class ProductController extends Controller
{
    ...
    private function data(Product $product):array{return compact('product')+['categories'=>ProductCategory::orderBy('name_en')->get(),'taxRates'=>TaxRate::where('is_active',true)->get()];}
}
