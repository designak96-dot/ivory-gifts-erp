...
Route::middleware('installed')->group(function(){
    ...
    Route::middleware(['auth','active'])->group(function(){
        ...
        Route::get('/finance/account-transfer',[AccountTransferController::class,'index'])->middleware('permission:accounting.view')->name('finance.account-transfer');
        Route::post('/finance/account-transfer',[AccountTransferController::class,'store'])->middleware('permission:accounting.manage')->name('finance.account-transfer.store');
        Route::get('/account-transfers/{transfer}/proof',[ProofController::class,'accountTransfer'])->middleware('permission:accounting.view')->name('account-transfer.proof');
